...
describe('BitcoinClient', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    let bitcoinClient;
    let fetchSpy;
    ...
    describe('createSidetreeTransaction', () => {
        it('should return the expected result', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('initialize', () => {
        it('should import key if the wallet does not exist', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should not import key if the wallet already exist', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const waitUntilBitcoinCoreIsReadySpy = spyOn(bitcoinClient, 'waitUntilBitcoinCoreIsReady').and.returnValue(Promise.resolve(true));
    ...
    describe('waitUntilBitcoinCoreIsReady', () => {
        it('should keep checking status until Bitcoin Core is fully sync-ed', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            const pollingWindowInSeconds = 0;
            yield bitcoinClient['waitUntilBitcoinCoreIsReady'](pollingWindowInSeconds);
            expect(rpcSpy).toHaveBeenCalledTimes(2);
        }));
        it('should keep checking status if error is encountered', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const firstBitcoinCoreState = undefined;
            const secondBitcoinCoreState = {
                headers: 100,
                blocks: 100
            };
    ...
    describe('broadcastSidetreeTransaction', () => {
        it('should call broadcastTransactionRpc with expected argument', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('broadcastLockTransaction', () => {
        it('should call the utility function with correct input.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('createLockTransaction', () => {
        it('should create the lock transaction.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('createRelockTransaction', () => {
        it('should create the relock transaction.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockFreezeTxn = BitcoinDataGenerator_1.default.generateBitcoinTransaction(bitcoinWalletImportString);
            spyOn(mockFreezeTxn, 'getFee').and.returnValue(122987);
    ...
    describe('createWallet', () => {
        it('should create a wallet', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw error when create wallet fails', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should log info when wallet already exists', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('loadWallet', () => {
        it('should load a wallet', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const rpcSpy = spyOn(bitcoinClient, 'rpcCall').and.returnValue({});
            const loggerSpy = spyOn(Logger_1.default, 'info');
        ...
        it('should throw error when load wallet fails', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const rpcSpy = spyOn(bitcoinClient, 'rpcCall').and.throwError('fake test error');
            try {
                yield bitcoinClient['loadWallet']();
                fail('should have thrown but did not');
        ...
        it('should log info when wallet is already loaded', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getBlock', () => {
        it('should get the block data.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getBlockHash', () => {
        it('should get the block hash', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const height = 512;
    ...
    describe('getBlockInfo', () => {
        it('should get the block info', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const height = 1234;
    ...
    describe('getCurrentBlockHeight', () => {
        it('should return the latest block', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const height = 753;
    ...
    describe('getRawTransaction', () => {
        it('should make the correct rpc call and return the transaction object', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getRawTransactionRpc', () => {
        ...
        it('should handle the case if the confirmations parameter from the blockchain is undefined', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const txnId = 'transaction_id';
    ...
    describe('getCurrentEstimatedFeeInSatoshisPerKB', () => {
        const expectedIsWalletRpc = false;
        it('should call the correct rpc and return the fee', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw if the feerate undefined', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw if the there are any errors returned', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('updateEstimatedFeeInSatoshisPerKB', () => {
        it('should always call the correct rpc and return the updated fee', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should always call the correct rpc and return the stored fee on error', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should rethrow RPC error when no fee was stored', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const spy = spyOn(bitcoinClient, 'getCurrentEstimatedFeeInSatoshisPerKB');
            spy.and.throwError('test');
            try {
    ...
    describe('getTransactionOutValueInSatoshi', () => {
        it('should return the satoshis from the correct output index.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getTransactionFeeInSatoshis', () => {
        it('should return the inputs - outputs.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockTxn = {
                id: 'someid',
                blockHash: 'block hash',
                confirmations: 4,
    ...
    describe('createBitcoinOutputModel', () => {
        it('should work if the output does not have any script', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getUnspentOutputs', () => {
        it('should query for unspent output coins given an address', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return empty if no coins were found', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const expectedIsWalletRpc = true;
            const minimumConfirmations = 0;
            const rpcCallSpy = verifyThenMockRpcCall('listunspent', expectedIsWalletRpc, [minimumConfirmations, null, [walletAddressFromBitcoinClient.toString()]], []);
            const actual = yield bitcoinClient['getUnspentOutputs'](walletAddressFromBitcoinClient);
    ...
    describe('addWatchOnlyAddressToWallet', () => {
        it('should call the importpubkey API', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const expectedIsWalletRpc = true;
    ...
    describe('broadcastTransactionRpc', () => {
        it('should call the correct rpc with the input.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const expectedIsWalletRpc = false;
        ...
        it('should throw if the RPC call fails.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const expectedIsWalletRpc = false;
            const mockRawTransaction = 'mocked-raw-transaction';
            const mockRpcOutput = 'mockRpcOutput';
            const spy = verifyThenMockRpcCall('sendrawtransaction', expectedIsWalletRpc, [mockRawTransaction], mockRpcOutput);
    ...
    describe('createTransaction', () => {
        ...
        it('should create the transaction object using fee passed in if it is greater', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should create the transaction object and apply markup and round up to nearest int when using the fee passed in', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const availableSatoshis = 5000;
            const unspentCoin = BitcoinDataGenerator_1.default.generateUnspentCoin(bitcoinWalletImportString, availableSatoshis);
            spyOn(bitcoinClient, 'getUnspentOutputs').and.returnValue(Promise.resolve([unspentCoin]));
            spyOn(bitcoinClient, 'calculateTransactionFee').and.returnValue(Promise.resolve(1));
        ...
        it('should create the transaction object using calculated fee if it is greater', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const availableSatoshis = 5000;
        ...
        it('should create the transaction object using calculated fee with markup, round up to nearest int', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const availableSatoshis = 5000;
            const calculatedFee = 3000;
            const unspentCoin = BitcoinDataGenerator_1.default.generateUnspentCoin(bitcoinWalletImportString, availableSatoshis);
            bitcoinClient['sidetreeTransactionFeeMarkupPercentage'] = 10;
    ...
    describe('calculateTransactionFee', () => {
        it('should calculate the fee correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw if no stored estimate and the fee estimate throws', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const spy = spyOn(bitcoinClient, 'getCurrentEstimatedFeeInSatoshisPerKB');
            spy.and.throwError('test');
            const mockTransaction = BitcoinDataGenerator_1.default.generateBitcoinTransaction(bitcoinWalletImportString, 10000);
            try {
        ...
        it('should use stored estimate, if estimate fails', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('createFreezeTransaction', () => {
        it('should create the freeze transaction correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('createSpendToFreezeTransaction', () => {
        it('should return the transaction by the utility function', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('createSpendTransactionFromFrozenTransaction', () => {
        it('should create the spend transaction correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('createUnspentOutputFromFrozenTransaction', () => {
        it('should create unspent output from input transaction', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockFreezeTxn = generateBitcoreTransactionWrapper(bitcoinWalletImportString, 12345);
            const mockFreezeUntilBlock = 987654;
            const mockRedeemScript = bitcore_lib_1.Script.empty().add(117);
            const mockRedeemScriptHashOutput = bitcore_lib_1.Script.buildScriptHashOut(mockRedeemScript);
    ...
    describe('createFreezeScript', () => {
        it('should create the correct redeem script', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getBalanceInSatoshis', () => {
        it('should call the unspentoutput API', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('isAddressAddedToWallet', () => {
        const expectedIsWalletRpc = true;
        it('should check if the wallet is watch only', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should check if the wallet has labels', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return false if it appears to be a random address', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('rpcCall', () => {
        it('should call retry-fetch with specific wallet.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const request = {};
        ...
        it('should call retry-fetch without specific wallet.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const request = {};
            const memberName = 'memberRequestName';
            const memberValue = 'memberRequestValue';
            request[memberName] = memberValue;
        ...
        it('should call retry-fetch without authorization', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const request = {};
            const memberName = 'memberRequestName';
            const memberValue = 'memberRequestValue';
            request[memberName] = memberValue;
            ...
            bitcoinClient.bitcoinAuthorization = undefined;
            const actualResult = yield bitcoinClient['rpcCall'](request, true, false);
            expect(actualResult).toEqual('abc');
            expect(retryFetchSpy).toHaveBeenCalled();
        ...
        it('should throw if the RPC call result contains an `error` property.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const request = {
    ...
    describe('fetchWithRetry', () => {
        it('should fetch the URI with the given requestParameters when timeout is enabled', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            const buffer = yield bitcoinClient['fetchWithRetry'](path, mockedRequestParams, true);
            expect(fetchSpy).toHaveBeenCalled();
            expect(readAllSpy).toHaveBeenCalled();
            expect(buffer).toEqual(mockBuffer);
            done();
        }));
        it('should fetch the URI with the given requestParameters when timeout is disabled.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockedRequestParams = { method: 'POST' };
            const mockedResponseBody = 'mockedBody';
            const mockedResponseStatus = 200;
            fetchSpy.and.callFake((uri, params) => {
            ...
            const path = 'http://unused_path';
            const buffer = yield bitcoinClient['fetchWithRetry'](path, mockedRequestParams, false);
            expect(fetchSpy).toHaveBeenCalled();
            expect(readAllSpy).toHaveBeenCalled();
            expect(buffer).toEqual(mockBuffer);
            done();
        }));
        it('should retry with increased timeout until max-retry reached if timeout is enabled.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockedRequestParams = { method: 'POST' };
            ...
            const path = 'http://unused_path';
            try {
                yield bitcoinClient['fetchWithRetry'](path, mockedRequestParams, true);
            }
            catch (error) {
                if (error instanceof Errors_1.default && error.type === 'request-timeout') {
        ...
        it('should throw non timeout errors thrown by fetch immediately.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockedRequestParams = { method: 'POST' };
            const mockedTimeoutError = new nodeFetchPackage.FetchError('test', 'unknown-error');
            ...
            try {
                ...
                if (error instanceof Errors_1.default && error.type === 'unknown-error') {
        ...
        it('should retry if response HTTP code is related to network connectivity issues.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockedResponseBody = 'unusedBody';
            fetchSpy.and.returnValues({ status: 502, body: mockedResponseBody }, { status: 200, body: mockedResponseBody });
            const readAllSpy = spyOn(ReadableStream_1.default, 'readAll').and.callFake(() => {
                return Promise.resolve(Buffer.from('unused'));
            });
            yield bitcoinClient['fetchWithRetry']('http://unused_path', {}, true);
            expect(fetchSpy).toHaveBeenCalledTimes(2);
            expect(readAllSpy).toHaveBeenCalledTimes(2);
            done();
        }));
        it('should throw if response HTTP code is an error not related to connectivity issues.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockedResponseBody = 'unusedBody';
            fetchSpy.and.returnValue({ status: 500, body: mockedResponseBody });
            const readAllSpy = spyOn(ReadableStream_1.default, 'readAll').and.returnValue(Promise.resolve(Buffer.from('unused')));
            yield JasmineSidetreeErrorValidator_1.default.expectSidetreeErrorToBeThrownAsync(() => bitcoinClient['fetchWithRetry']('http://unused_path', {}, true), ErrorCode_1.default.BitcoinClientFetchUnexpectedError);
            expect(fetchSpy).toHaveBeenCalledTimes(1);
