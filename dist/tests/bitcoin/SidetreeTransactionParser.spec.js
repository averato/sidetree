...
describe('SidetreeTransactionParser', () => {
    ...
    describe('parse', () => {
        it('should return undefined if the sidetree data is invalid', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockTxn = {
                id: 'some id',
                blockHash: 'hash',
                confirmations: 1,
        ...
        it('should return undefined if the writer data is invalid', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockTxn = {
                id: 'some id',
                blockHash: 'hash',
                confirmations: 1,
        ...
        it('should return correct expected data', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getValidSidetreeDataFromOutputs', () => {
        it('should return the sidetree data if only one output has the data present', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return undefined if no output has any sidetree data.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should only return the first output with the sidetree data.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockOutputs = [
                createValidDataOutput('mock data 1'),
                createValidDataOutput('mock data 2'),
                createValidDataOutput('mock data 2')
    ...
    describe('getSidetreeDataFromOutputIfExist', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should return the data if the valid sidetree transaction exist', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return undefined if no valid sidetree transaction exist', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return undefined if data does not start with sidetree prefix', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const sidetreeData = 'some test data';
            const mockDataOutput = createValidDataOutput(sidetreeData);
    ...
    describe('getValidWriterFromInputs', () => {
        it('should return undefined if the number of inputs are less than 1', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const actual = yield sidetreeTxnParser['getValidWriterFromInputs']('txn id', []);
            expect(actual).toBeUndefined();
            done();
        }));
        it('should return undefined if the script asm has only 1 values', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockInput = [
        ...
        it('should return undefined if the script asm has 3 values', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockInput = [
        ...
        it('should return undefined if the output being spent is not found.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return the value returned by the utitlity function.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('fetchOutput', () => {
        it('should return the otuput returned by calling the bitcoin client', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockTxn = {
                id: 'id',
        ...
        it('should throw if fetch throws', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockError = new node_fetch_1.FetchError('mocked test error', 'request-timeout');
            spyOn(sidetreeTxnParser['bitcoinClient'], 'getRawTransaction').and.callFake(() => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                throw mockError;
            }));
            try {
