...
describe('LockResolver', () => {
    ...
    describe('resolveSerializedLockIdentifierAndThrowOnError', () => {
        it('should deserialize the identifier and call the other function', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('resolveLockIdentifierAndThrowOnError', () => {
        it('should correctly resolve a valid lock identifier.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            const mockFeeCalculator = {
                ...
                getNormalizedFee() {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () { return mockNormalizedFee; });
                },
                addNormalizedFeeToBlockMetadata(block) {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () { return Object.assign({ normalizedFee: mockNormalizedFee }, block); });
                }
            };
        ...
        it('should throw if redeem script is not a lock script.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockLockIdentifier = {
                transactionId: 'some transactoin id',
        ...
        it('should throw if the transaction output is not paying to the linked wallet.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockLockIdentifier = {
                transactionId: 'some transactoin id',
        ...
        it('should throw if the lock duration is invalid.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockLockIdentifier = {
                transactionId: 'some transactoin id',
                redeemScriptAsHex: 'validScript to - Hex'
            };
    ...
    describe('isRedeemScriptALockScript', () => {
        it('should validate and return the correct block if the script is valid.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return false and 0 for block height if the script is invalid', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const validScript = createValidLockRedeemScript(1234, validTestWalletAddress);
            const invalidScript = validScript.add(114);
    ...
    describe('isOutputPayingToTargetScript', () => {
        it('should return true if the output is paying to the target script.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return false for any other script.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const validScript = createValidLockRedeemScript(4758759, validTestWalletAddress);
    ...
    describe('createScript', () => {
        it('should return script from the hex.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw if script creation throws.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getTransaction', () => {
        ...
        it('should throw not-found error if there is an exception thrown by the bitcoin client', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('calculateLockStartingBlock', () => {
        it('should calculate the correct starting block', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockTransaction = {
                id: 'some id',
                blockHash: 'block hash',
                confirmations: 23,
        ...
        it('should throw if the number of confirmations on the input is < 0', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockTransaction = {
                id: 'some id',
                blockHash: 'block hash',
                confirmations: -2,
