...
describe('NormalizedFeeCalculator', () => {
  ...
  describe('initialize', () => {
    it('should initialize members correctly', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  describe('addNormalizedFeeToBlock', () => {
    ...
    it('should return initial fee for blocks within genesis + lookBackDuration', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should calculate normalized fee and fetch for blocks when starting fresh', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should calculate normalized fee and use cache', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      blockMetadataWithoutFee.height = 101;
    ...
    it('should calculate normalized fee using db if cache does not have the correct number of blocks', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      blockMetadataWithoutFee.height = 101;
      normalizedFeeCalculator['blockHeightOfCachedLookBackWindow'] = 101;
      const getMetadataSpy = spyOn(mockMetadataStore, 'get').and.returnValue(Promise.resolve([
        {
    ...
    it('should return the correct fee above fluctuation for blocks after genesis + 100 blocks.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      blockMetadataWithoutFee.height = 101;
      normalizedFeeCalculator['blockHeightOfCachedLookBackWindow'] = 101;
    ...
    it('should return the correct fee below fluctuation for blocks after genesis + 100 blocks.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      blockMetadataWithoutFee.height = 101;
      normalizedFeeCalculator['blockHeightOfCachedLookBackWindow'] = 101;
      spyOn(mockMetadataStore, 'get').and.returnValue(Promise.resolve([
        {
    ...
    it('should return the correct fee within fluctuation for blocks after genesis + 100 blocks.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      blockMetadataWithoutFee.height = 101;
      normalizedFeeCalculator['blockHeightOfCachedLookBackWindow'] = 101;
      spyOn(mockMetadataStore, 'get').and.returnValue(Promise.resolve([
        {
  ...
  describe('getNormalizedFee', () => {
    it('should return recalculated normalized fee from db', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const blocks = [{
        height: 0,
        hash: 'hash',
        previousHash: 'prevHash',
    ...
    it('should throw when block not yet recognized', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const blocks = [];
