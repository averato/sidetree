  ...
  fetchOutput (transactionId, outputIndexToFetch) {
    return tslib_1.__awaiter(this, void 0, void 0, function * () {
      try {
        ...
        if (e instanceof SidetreeError_1.default) { Logger_1.default.error(`Error while trying to get outputIdx: ${outputIndexToFetch} from transaction: ${transactionId}. Error: ${SidetreeError_1.default.stringify(e)}`); }
        throw e;
      }
    });
  }
