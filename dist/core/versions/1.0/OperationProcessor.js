  ...
  applyUpdateOperation (anchoredOperationModel, didState) {
    return tslib_1.__awaiter(this, void 0, void 0, function * () {
      ...
      try {
        ...
        const didUniqueSuffix = anchoredOperationModel.didUniqueSuffix;
        const transactionNumber = anchoredOperationModel.transactionNumber;
        if (error instanceof SidetreeError_1.default) { Logger_1.default.info(`Unable to apply document patch in transaction number ${transactionNumber} for DID ${didUniqueSuffix}: ${SidetreeError_1.default.stringify(error)}.`); }
      }
      return newDidState;
    });
  }
