...
class BitcoinWallet {
  constructor (bitcoinWalletImportString) {
    try {
      ...
      if (error instanceof SidetreeError_1.default) { throw SidetreeError_1.default.createFromError(ErrorCode_1.default.BitcoinWalletIncorrectImportString, error); }
      throw error;
    }
