...
describe('BitcoinProcessor', () => {
    ...
    describe('initialize', () => {
        ...
        it('should initialize the internal objects', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should not start transaction observer polling if polling is turned off.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            bitcoinProcessor.config.transactionPollPeriodInSeconds = 0;
            yield bitcoinProcessor.initialize(versionModels);
            expect(periodicPollSpy).not.toHaveBeenCalled();
        }));
        it('should skip initialization if unable to find a starting block.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            getStartingBlockForPeriodicPollSpy.and.returnValue(Promise.resolve(undefined));
            yield bitcoinProcessor.initialize(versionModels);
        ...
        it('should process all the blocks since its last known', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should process all the blocks since its last known With fastProcessTransactions', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should begin to periodically poll for updates', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            expect(periodicPollSpy).not.toHaveBeenCalled();
            yield bitcoinProcessor.initialize(versionModels);
    ...
    describe('time', () => {
        it('should get the current latest when given no hash', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should get the corresponding bitcoin height given a hash', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const height = randomNumber();
            const hash = randomString();
    ...
    describe('transactions()', () => {
        beforeEach(() => {
            const mockFeeCalculator = {
                ...
                getNormalizedFee() {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () { return 509; });
                },
                addNormalizedFeeToBlockMetadata() {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () { return {}; });
                }
            };
            spyOn(bitcoinProcessor['versionManager'], 'getFeeCalculator').and.returnValue(mockFeeCalculator);
        });
        it('should get transactions since genesis capped by page size in blocks', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw if block metadata does not match transaction requirements', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should get transactions since genesis and handle mid block processing', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const verifyMock = spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(true));
            const transactions = createTransactions(BitcoinProcessor_1.default['pageSizeInBlocks'], bitcoinProcessor['genesisBlockNumber'], true, true);
        ...
        it('should return no transaction if last processed block in DB is not found.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should get transactions since genesis and handle complete last block', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const verifyMock = spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(true));
            const transactions = createTransactions(BitcoinProcessor_1.default['pageSizeInBlocks'], bitcoinProcessor['genesisBlockNumber'], true, true);
        ...
        it('should get transactions since genesis and handle past last block', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const verifyMock = spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(true));
        ...
        it('should find at least 1 transaction and return', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const verifyMock = spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(true));
        ...
        it('should return default if transactions is empty array', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const verifyMock = spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(true));
            const mockLastProcessedBlock = {
        ...
        it('should get transactions since a specific block height and hash', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            const lastBlockHeight = BitcoinProcessor_1.default['pageSizeInBlocks'] + expectedHeight - 1;
        ...
        it('should fail if only given a block height', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
        ...
        it('should fail if the height and hash do not validate against the current blockchain', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const expectedHeight = randomNumber();
            const expectedHash = randomString();
            const expectedTransactionNumber = TransactionNumber_1.default.construct(expectedHeight, 0);
        ...
        it('should return no transactions if bitcoin service is in a forked state.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const expectedHeight = randomNumber();
            const expectedHash = randomString();
            const expectedTransactionNumber = TransactionNumber_1.default.construct(expectedHeight, 0);
        ...
        it('should make moreTransactions true when last block processed is not reached', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockLastProcessedBlock = {
    ...
    describe('firstValidBlock', () => {
        it('should return the first of the valid transactions', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return undefined if no valid transactions are found', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blocks = BlockMetadataGenerator_1.default.generate(10);
            const verifyMock = spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(false));
            const actual = yield bitcoinProcessor.firstValidBlock(blocks);
    ...
    describe('writeTransaction', () => {
        ...
        it('should write a transaction if there are enough Satoshis', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should fail if there are not enough satoshis to create a transaction', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const monitorAddSpy = spyOn(bitcoinProcessor['spendingMonitor'], 'addTransactionDataBeingWritten');
        ...
        it('should fail if the current fee is over the spending limits', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const monitorAddSpy = spyOn(bitcoinProcessor['spendingMonitor'], 'addTransactionDataBeingWritten');
    ...
    describe('getNormalizedFee', () => {
        ...
        it('should throw if the input is less than the genesis block', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
        ...
        it('should return the value from the normalized fee calculator.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockFeeCalculator = {
                calculateNormalizedTransactionFeeFromBlock(block) { return Math.floor(block.normalizedFee); },
                getNormalizedFee() {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () { return 509; });
        ...
        it('should return the value from the normalized fee calculator when passed in a string representation of block number.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockFeeCalculator = {
                calculateNormalizedTransactionFeeFromBlock(block) { return Math.floor(block.normalizedFee); },
    ...
    describe('periodicPoll', () => {
        ...
        it('should call processTransactions from its last known point', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const lastBlock = {
                height: randomNumber(),
                hash: randomString(),
                previousHash: randomString(),
        ...
        it('should not call process transaction if the starting block is undefined', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            getStartingBlockForPeriodicPollSpy.and.returnValue(Promise.resolve(undefined));
            yield bitcoinProcessor['periodicPoll']();
            setTimeout(() => {
                expect(bitcoinProcessor['pollTimeoutId']).toBeDefined();
        ...
        it('should not throw if the processing throws', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should set a timeout to call itself', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should clear the previous timeout if set', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            getStartingBlockForPeriodicPollSpy.and.returnValue(Promise.resolve());
    ...
    describe('processBlocks', () => {
        it('should process as intended', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('findEarliestValidBlockAndAddToValidBlocks', () => {
        it('should return new height and hash and update validBlocks while ignoring extra blocks', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return original values when no valid blocks are found', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const validBlocks = [];
    ...
    describe('removeTransactionsInInvalidBlocks', () => {
        it('should process invalid blocks as intended', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('writeBlocksToMetadataStoreWithFee', () => {
        it('should process the correct transactions', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockMetadata = [
                {
                    height: 999999,
                    hash: 'someHash1',
            ...
            const mockFeeCalculator = {
                ...
                addNormalizedFeeToBlockMetadata(block) {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () { return Object.assign({ normalizedFee: 111 }, block); });
                }
            };
            spyOn(bitcoinProcessor['versionManager'], 'getFeeCalculator').and.returnValue(mockFeeCalculator);
    ...
    describe('fastProcessTransactions', () => {
        ...
        it('should process transactions as intended', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should process transactions as intended with no raw data', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const startBlock = randomBlock(testConfig.genesisBlockNumber);
            const getCurrentHeightMock = spyOn(bitcoinProcessor['bitcoinClient'], 'getCurrentBlockHeight').and.returnValue(Promise.resolve(startBlock.height + 1));
            const getCurrentHashMock = spyOn(bitcoinProcessor['bitcoinClient'], 'getBlockInfoFromHeight')
                .and.returnValue(Promise.resolve({ hash: 'hash2', height: startBlock.height + 1, previousHash: 'hash1' }));
    ...
    describe('processTransactions', () => {
        ...
        it('should verify the start block', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should call processBlock on all blocks within range', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockProcessedBlockMetadata = BlockMetadataGenerator_1.default.generate(1)[0];
            const startBlock = randomBlock(testConfig.genesisBlockNumber);
            const processMock = spyOn(bitcoinProcessor, 'processBlock').and.returnValue(Promise.resolve(mockProcessedBlockMetadata));
        ...
        it('should throw if asked to start processing before genesis', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should recall previous hashes when calling processBlock', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockProcessedBlockMetadatas = BlockMetadataGenerator_1.default.generate(10);
    ...
    describe('getStartingBlockForPeriodicPoll', () => {
        ...
        it('should return the block after the last-processed-block', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(true));
        ...
        it('should return undefined if the last-processed-block is same as the current height', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            spyOn(bitcoinProcessor, 'verifyBlock').and.returnValue(Promise.resolve(true));
        ...
        it('should revert blockchain if verifyblock fails', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should use genesis block as the starting block if no last processed block is found.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should use genesis block as the starting block if no valid block is left after reverting.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('revertDatabases', () => {
        it('should invoke trimDatabasesToBlock() correctly and return the correct block info.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blocks = BlockMetadataGenerator_1.default.generate(10);
        ...
        it('should return `undefined` as the last valid block if all data have been reverted.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blocks = BlockMetadataGenerator_1.default.generate(10);
            const lookBackExponentiallySpy = spyOn(bitcoinProcessor['blockMetadataStore'], 'lookBackExponentially').and.returnValue(Promise.resolve(blocks));
    ...
    describe('trimDatabasesToBlock', () => {
        it('should call the internal data removal methods with correct values.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should call internal data removal methods with `undefined` if no block height is given.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            trimDatabasesToBlockSpy.and.callThrough();
            const removeBlocksLaterThanSpy = spyOn(bitcoinProcessor['blockMetadataStore'], 'removeLaterThan');
            const removeTransactionsLaterThanSpy = spyOn(bitcoinProcessor['transactionStore'], 'removeTransactionsLaterThan');
    ...
    describe('verifyBlock', () => {
        it('should return true if the hash matches given a block height', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const height = randomNumber();
            const hash = randomString();
            bitcoinProcessor['lastProcessedBlock'] = {
                height: 1234,
        ...
        it('should return false if the hash does not match given a block height', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const height = randomNumber();
            const hash = randomString();
            bitcoinProcessor['lastProcessedBlock'] = {
                height: 1234,
        ...
        it('should return false if the height passed in is outside block height range', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const height = randomNumber();
            const hash = randomString();
            bitcoinProcessor['lastProcessedBlock'] = {
                height: 1234,
    ...
    describe('processBlock', () => {
        it('should review all transactions in a block and add valid sidetree txns to the transactionStore', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            ...
            const mockFeeCalculator = {
                ...
                addNormalizedFeeToBlockMetadata(block) {
                    return tslib_1.__awaiter(this, void 0, void 0, function* () { return Object.assign({ normalizedFee: 300 }, block); });
                }
            };
            spyOn(bitcoinProcessor['versionManager'], 'getFeeCalculator').and.returnValue(mockFeeCalculator);
        ...
        it('should not add anything to the transaction store if no sidetree transaction is found.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const block = randomNumber();
            const blockHash = randomString();
            const blockData = {
                height: block,
        ...
        it('should throw if any exception is thrown while going through transactions.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const block = randomNumber();
            const blockHash = randomString();
            const blockData = {
                height: block,
        ...
        it('should throw if the previousBlockHash does not match the bitcoin block retrieved', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const block = randomNumber();
    ...
    describe('getSidetreeTransactionModelIfExist', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should only return the sidetree transaction data if exist.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return undefined if the parse result is undefined.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getServiceVersion', () => {
        it('should return the correct response body for the version request', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getValueTimeLock', () => {
        it('should call the lock resolver and return the value from it.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw request error if lockresolver throws any exception', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getActiveValueTimeLockForThisNode', () => {
        it('should return the value-time-lock from the lock monitor', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockValueTimeLock = {
                amountLocked: 1000,
                identifier: 'lock identifier',
                owner: 'owner',
        ...
        it('should throw not-found error if the lock monitor returns undefined.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw pending-state exception if the lock monitor throws pending-state error', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should bubble up any other errors.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('upgradeDatabaseIfNeeded', () => {
        ...
        it('should not perform upgrade if saved database version is the same as the expected version.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should perform upgrade if saved database version is older than the expected database version.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const serviceStateStorePutSpy = spyOn(bitcoinProcessor['serviceStateStore'], 'put');
