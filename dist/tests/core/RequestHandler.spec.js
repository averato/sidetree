...
describe('RequestHandler', () => {
  ...
  it('should resolve long form did from test vectors correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should process create operation from test vectors correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    const createOperationBuffer = Buffer.from(JSON.stringify(generatedFixture.create.operationRequest));
    const response = yield requestHandler.handleOperationRequest(createOperationBuffer);
    expect(response.status).toEqual(ResponseStatus_1.default.Succeeded);
  }));
  it('should process update operation from test vectors correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should process recover operation from test vectors correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should process deactivate operation from test vectors correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should queue operation request and have it processed by the batch scheduler correctly.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    expect(chunkFile.deltas.length).toEqual(3);
  }));
  it('should return bad request if delta given in request is larger than protocol limit.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should return bad request if two operations for the same DID is received.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should return a correctly resolved DID Document given a known DID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should return a resolved DID Document given a valid long-form DID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should return NotFound given an unknown DID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should return BadRequest given a malformed DID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should respond with HTTP 200 when DID deactivate operation request is successful.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should respond with HTTP 200 when an update operation request is successful.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  it('should respond with HTTP 200 when a recover operation request is successful.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  describe('handleResolveRequest()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    it('should return internal server error if non-Sidetree error has occurred.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('[Bug #817] should return status as `deactivated` if DID is deactivated.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  describe('handleOperationRequest()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    it('should return `BadRequest` if unknown error is thrown during generic operation parsing stage.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should return `BadRequest` if operation of an unknown type is given.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should return `BadRequest` if Sidetree error is thrown during operation processing stage.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should return `ServerError` if non-Sidetree error is thrown during operation processing stage.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  describe('handleCreateRequest()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    it('should return `BadRequest` if unable to generate initial DID state from the given create operation model.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const createOperationData = yield OperationGenerator_1.default.generateCreateOperation();
      const createOperation = createOperationData.createOperation;
  ...
  describe('resolveLongFormDid()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    it('should return the resolved DID document, and `published` value as `true` if it is resolvable as a registered DID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
