...
describe('Blockchain', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    describe('read()', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should return transactions fetched.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw SidetreeError with correct code when if invalid time hash is given.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            const mockFetchResponse = {
                status: 400,
                body: {
        ...
        it('should throw if error is encountered when reading transactions.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            const mockFetchResponse = {
                status: 500,
                body: {
            ...
            try {
                ...
                if (error instanceof SidetreeError_1.default && error.code !== ErrorCode_1.default.BlockchainReadResponseNotOk) {
                    fail();
                }
                return;
            }
        ...
        it('should throw if not both the transaction time and hash are given.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            try {
                yield blockchainClient.read(1, undefined);
            }
            catch (error) {
                if (error instanceof SidetreeError_1.default && error.code !== ErrorCode_1.default.BlockchainReadInvalidArguments) {
                    fail();
                }
                return;
            }
        ...
        it('should throw if response body fails JSON parse.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
    ...
    describe('write()', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should write as expected', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw SidetreeError with correct error code if blockchain service returns an unexpected error.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            const mockFetchResponse = {
                status: 500,
                body: {
        ...
        it('should throw SidetreeError with correct error code if blockchain service returns a known Sidetree error.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
    ...
    describe('getFirstValidTransaction()', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should return the transaction returned by the underlying blockchain service.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            const mockFetchResponse = {
                status: 200,
                body: {
        ...
        it('should return undefined if valid transaction cannot be found.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            const mockFetchResponse = {
                status: 404,
                body: {
    ...
    describe('getLatestTime()', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should return the latest time', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            const mockFetchResponse = {
                status: 200,
                body: {
        ...
        it('should throw if encountered error when fetching time from blockchain service.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('Unused URI');
            const mockFetchResponse = {
                status: 500,
                body: {
            ...
            try {
                ...
                if (error instanceof SidetreeError_1.default && error.code !== ErrorCode_1.default.BlockchainGetLatestTimeResponseNotOk) {
                    fail();
                }
                return;
            }
    ...
    describe('getCachedVersion', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should get the version from the service version fetcher', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getFee', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        it('should get the fee returned by the blockchain service', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
        ...
        it('should throw if the response is not 200', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
            const mockFetchResponse = {
                status: 500,
                body: '{}'
        ...
        it('should throw if the response is 400 with the specific error code', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
            const mockFetchResponse = {
                status: 400,
        ...
        it('should throw if the response is 400 but the error code is generic', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
            const mockFetchResponse = {
                status: 400,
    ...
    describe('getValueTimeLock', () => {
        it('should return the object returned by the network call.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
        ...
        it('should return undefined if not-found is returned by the network call.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
            const mockFetchResponse = {
                status: 404,
        ...
        it('should throw if there is any other error returned by the network call.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
            const mockFetchResponse = {
                status: 500,
                body: '{"code": "some error code"}'
    ...
    describe('getWriterValueTimeLock', () => {
        ...
        it('should return undefined if pending-state error is returned by the network call.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
            const mockFetchResponse = {
                status: 404,
        ...
        it('should throw generic error if HTTP 200 is not returned by the network call.', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const blockchainClient = new Blockchain_1.default('unused');
            const mockFetchResponse = {
                status: 500,
                body: '{"code": "some error code"}'
