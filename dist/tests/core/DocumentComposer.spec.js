...
describe('DocumentComposer', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  describe('transformToExternalDocument', () => {
    it('should output the expected resolution result with a shortForm identifier given key(s) across all purpose types.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should output the expected resolution result with a longForm identifier given key(s) across all purpose types.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const [anySigningPublicKey] = yield OperationGenerator_1.default.generateKeyPair('anySigningKey');
      const [noPurposePublicKey] = yield OperationGenerator_1.default.generateKeyPair('noPurposePublicKey', []);
      const [authPublicKey] = yield OperationGenerator_1.default.generateKeyPair('authPublicKey', [PublicKeyPurpose_1.default.Authentication]);
      const document = {
    ...
    it('should output method metadata with the given `published` value.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const [anySigningPublicKey] = yield OperationGenerator_1.default.generateKeyPair('anySigningKey');
      const [authPublicKey] = yield OperationGenerator_1.default.generateKeyPair('authPublicKey', [PublicKeyPurpose_1.default.Authentication]);
      const document = {
    ...
    it('should output DID document metadata with canonicalId only if published.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const [anySigningPublicKey] = yield OperationGenerator_1.default.generateKeyPair('anySigningKey');
      const [authPublicKey] = yield OperationGenerator_1.default.generateKeyPair('authPublicKey', [PublicKeyPurpose_1.default.Authentication]);
      const document = {
        publicKeys: [anySigningPublicKey, authPublicKey]
    ...
    it('should output DID document metadata with equivalentId only if is not short form.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const [anySigningPublicKey] = yield OperationGenerator_1.default.generateKeyPair('anySigningKey');
      const [authPublicKey] = yield OperationGenerator_1.default.generateKeyPair('authPublicKey', [PublicKeyPurpose_1.default.Authentication]);
      const document = {
        publicKeys: [anySigningPublicKey, authPublicKey]
    ...
    it('should return status deactivated if next recovery commit hash is undefined', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const [anySigningPublicKey] = yield OperationGenerator_1.default.generateKeyPair('anySigningKey');
      const [authPublicKey] = yield OperationGenerator_1.default.generateKeyPair('authPublicKey', [PublicKeyPurpose_1.default.Authentication]);
      const document = {
        publicKeys: [anySigningPublicKey, authPublicKey]
  ...
  describe('validateRemoveServicesPatch', () => {
    it('should throw error if a remove-services patch contains additional unknown property.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patch = {
        extra: 'unknown value',
        action: PatchAction_1.default.RemoveServices,
        ids: 'not an array'
  ...
  describe('validateDocumentPatches()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    it('should throw error if `patches` is not an array.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should throw error if given `action` is unknown.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should throw error if an add-public-keys patch contains additional unknown property.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
      patches[0].unknownProperty = 'unknownProperty';
      const expectedError = new SidetreeError_1.default(ErrorCode_1.default.DocumentComposerPatchMissingOrUnknownProperty);
      expect(() => { DocumentComposer_1.default.validateDocumentPatches(patches); }).toThrow(expectedError);
    }));
    it('should throw error if `publicKeys` in an add-public-keys patch is not an array.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if an entry in `publicKey` in an add-public-keys patch contains additional unknown property.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if `id` of a public key in an add-public-keys patch is not a string.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if the a secp256k1 public key in an add-public-keys patch is not specified in `publicKeyJwk` property.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if `type` of a public key is not a string.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if a remove-public-keys patch contains additional unknown property.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if `ids` in an remove-public-keys patch is not an array.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if any of the entries in `ids` in a remove-public-keys patch is not a string.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
      patches[1].ids[0] = { invalidType: true };
      JasmineSidetreeErrorValidator_1.default.expectSidetreeErrorToBeThrown(() => DocumentComposer_1.default.validateDocumentPatches(patches), ErrorCode_1.default.DocumentComposerIdNotString);
    }));
    it('should throw error if `services` in an add-services patch is not an array.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
    ...
    it('should throw error if any of the `services` entry in the add-services patch is not a valid DID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const patches = generatePatchesForPublicKeys();
  ...
  describe('applyPatches()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    it('should add a key even if no keys exist yet.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {};
    ...
    it('should replace old state entirely if the patch action is a replace.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      var _a, _b;
      const document = {
    ...
    it('should replace old key with the same ID with new values.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        publicKeys: [{ id: 'aRepeatingId', type: 'someType', publicKeyJwk: 'any value' }],
        services: []
      };
    ...
    it('should throw if action is not a valid patch action', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {};
      const patches = [
        {
  ...
  describe('validateId()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    it('should throw if ID given is not using characters from Base64URL character set.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
  ...
  describe('validateDocument()', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
    ...
    it('should throw if document contains 2 services with the same ID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        services: [
          {
            id: 'key1',
    ...
    it('should throw if document contains 2 keys with the same ID.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        publicKeys: [
          {
            id: 'key1',
    ...
    it('should process as expected if document public key purposes is empty array.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        publicKeys: [
          {
            id: 'key1',
    ...
    it('should process as expected if document public key purposes is undefined.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        publicKeys: [
          {
            id: 'key1',
    ...
    it('should throw if document public key purposes is not an array.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        publicKeys: [
          {
            id: 'key1',
    ...
    it('should throw if document public key purposes is bigger than expected length.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        publicKeys: [
          {
            id: 'key1',
    ...
    it('should throw if document public key contains invalid purpose.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        publicKeys: [
          {
            id: 'key1',
    ...
    it('should throw if document contains unknown property.', () => tslib_1.__awaiter(void 0, void 0, void 0, function * () {
      const document = {
        unknownProperty: 'any value'
      };
      yield JasmineSidetreeErrorValidator_1.default.expectSidetreeErrorToBeThrownAsync(() => tslib_1.__awaiter(void 0, void 0, void 0, function * () { DocumentComposer_1.default['validateDocument'](document); }), ErrorCode_1.default.DocumentComposerUnknownPropertyInDocument);
    }));
  }));
}));
