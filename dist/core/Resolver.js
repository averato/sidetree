  ...
  applyOperation (operation, didState) {
    return tslib_1.__awaiter(this, void 0, void 0, function * () {
      ...
      try {
        ...
        if (error instanceof SidetreeError_1.default) { Logger_1.default.info(`Skipped bad operation for DID ${operation.didUniqueSuffix} at time ${operation.transactionTime}. Error: ${SidetreeError_1.default.stringify(error)}`); }
        throw error;
      }
