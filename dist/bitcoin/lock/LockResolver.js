...
class LockResolver {
  ...
  static createScript (redeemScriptAsHex) {
    try {
      ...
      if (e instanceof SidetreeError_1.default) { throw SidetreeError_1.default.createFromError(ErrorCode_1.default.LockResolverRedeemScriptIsInvalid, e); }
      throw e;
    }
  }
  ...
  getTransaction (transactionId) {
    return tslib_1.__awaiter(this, void 0, void 0, function * () {
      try {
        ...
        if (e instanceof SidetreeError_1.default) { throw SidetreeError_1.default.createFromError(ErrorCode_1.default.LockResolverTransactionNotFound, e); }
        throw e;
      }
    });
  }
