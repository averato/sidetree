  ...
  static parse (coreProofFileBuffer, expectedDeactivatedDidUniqueSuffixes) {
    return tslib_1.__awaiter(this, void 0, void 0, function * () {
      ...
      try {
        ...
        if (error instanceof SidetreeError_1.default) { throw SidetreeError_1.default.createFromError(ErrorCode_1.default.CoreProofFileDecompressionFailure, error); }
        throw error;
      }
      ...
      try {
        ...
        if (error instanceof SidetreeError_1.default) { throw SidetreeError_1.default.createFromError(ErrorCode_1.default.CoreProofFileNotJson, error); }
        throw error;
      }
