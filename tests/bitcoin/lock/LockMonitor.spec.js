...
describe('LockMonitor', () => {
    ...
    describe('startPeriodicProcessing', () => {
        it('should call the periodic poll function', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('periodicPoll', () => {
        it('should call setTimeout() at the end of the execution.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should call setTimeout() at the end of the execution even if an exception is thrown.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getCurrentValueTimeLock', () => {
        it('should return undefined if there is no current lock', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return the current value time lock', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('handlePeriodicPolling', () => {
        it('should only refresh the lock state if lock update is disabled.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockCurrentValueLock = {
                amountLocked: 300,
                identifier: 'identifier',
                owner: 'owner',
        ...
        it('should rebroadcast if the last lock transaction is still pending.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should not do anything if a lock is not required and none exist.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should call the new lock routine if a lock is required but does not exist.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockCurrentLockInfo = createLockState(undefined, undefined, 'none');
        ...
        it('should call the renew lock routine if a lock is required and one does exist.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockSavedLock = {
                createTimestamp: 1212,
                desiredLockAmountInSatoshis: 300,
                rawTransaction: 'raw transaction',
        ...
        it('should not resolve the current lock information if the renew routine returns false.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockSavedLock = {
                createTimestamp: 1212,
                desiredLockAmountInSatoshis: 300,
                rawTransaction: 'raw transaction',
        ...
        it('should call the release lock routine if a lock is not required but one does exist.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockSavedLock = {
                createTimestamp: 1212,
                desiredLockAmountInSatoshis: 300,
                rawTransaction: 'raw transaction',
        ...
        it('should always refresh the lock state even if the the release lock routine returns false.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockSavedLock = {
                createTimestamp: 1212,
                desiredLockAmountInSatoshis: 300,
                rawTransaction: 'raw transaction',
    ...
    describe('getCurrentLockState', () => {
        it('should return an empty object if no locks were found in the db.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return lock status as pending if the last lock transaction is not yet broadcasted.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const resolveLockSpy = spyOn(lockResolver, 'resolveLockIdentifierAndThrowOnError');
            const mockLastLock = {
        ...
        it('should just return without resolving anything if the last transaction was return-to-wallet.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return the resolved output.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const rebroadcastSpy = spyOn(lockMonitor, 'rebroadcastTransaction').and.returnValue(Promise.resolve());
        ...
        it('should return pending if the lock resolver throws not-confirmed error.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const rebroadcastSpy = spyOn(lockMonitor, 'rebroadcastTransaction').and.returnValue(Promise.resolve());
        ...
        it('should bubble up any unhandled exceptions.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const rebroadcastSpy = spyOn(lockMonitor, 'rebroadcastTransaction').and.returnValue(Promise.resolve());
    ...
    describe('rebroadcastTransaction', () => {
        it('should broadcast the txn via bitcoin-client', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('isTransactionBroadcasted', () => {
        it('should return true if the bitcoin client returns the transaction', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return false if there is an exception thrown by the bitcoin client', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('handleCreatingNewLock', () => {
        it('should create the first lock', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw if the wallet balance is less than the desired lock amount', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('handleExistingLockRenewal', () => {
        it('should return if the we have not reached the unlock block yet.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should call release lock if the new desired lock amount is different than the previously saved one.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockUnlockTxnTime = 4500;
            const currentValueTimeLockInput = {
                amountLocked: 5000,
                identifier: 'some identifier',
        ...
        it('should call renew lock if we are at the unlock block and the desired lock amount is same as the last time.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockUnlockTxnTime = 4500;
            const currentValueTimeLockInput = {
                amountLocked: 5000,
                identifier: 'some identifier',
        ...
        it('should call release lock if we do not have enough balance for relock.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockUnlockTxnTime = 4500;
            const currentValueTimeLockInput = {
                amountLocked: 5000,
                identifier: 'some identifier',
        ...
        it('should just bubble up any unhandled errors.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockUnlockTxnTime = 4500;
            const currentValueTimeLockInput = {
                amountLocked: 5000,
                identifier: 'some identifier',
    ...
    describe('handleReleaseExistingLock', () => {
        it('should not call the renew lock routine if the lock time has not reached.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            spyOn(lockMonitor, 'isUnlockTimeReached').and.returnValue(Promise.resolve(false));
            const releaseLockSpy = spyOn(lockMonitor, 'releaseLock');
            const currentValueTimeLockInput = {
                amountLocked: 5000,
        ...
        it('should call the renew lock routine if the lock time has reached.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            spyOn(lockMonitor, 'isUnlockTimeReached').and.returnValue(Promise.resolve(true));
    ...
    describe('renewLock', () => {
        it('should renew the existing lock and save the updated information to the db', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should throw if the renew fees are causing the new lock amount to be less than the desired lock.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockCurrentLockId = {
                redeemScriptAsHex: 'redeem script as hex',
                transactionId: 'transaction id'
            };
    ...
    describe('releaseLock', () => {
        it('should release the lock and save the updated information to the db', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockCurrentLockId = {
                redeemScriptAsHex: 'redeem script as hex',
                transactionId: 'transaction id'
            };
    ...
    describe('saveThenBroadcastTransaction', () => {
        it('save the transaction first and then broadcast it.', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('isUnlockTimeReached', () => {
        it('should return true if we at the unlock block', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should return false if we are below the unlock block', (done) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const mockUnlockTime = 12345;
